...
<head>
    ...
    <%
        int nno = (request.getParameter("nno") != null) ? Integer.parseInt(request.getParameter("nno")) : 0;
    ...
    <div class="contents" id="contents">
        <div class="content_header">
            <div class="breadcrumb">
                <p><a href="<%=path %>">Home</a> &gt; <a href="<%=path %>/notice/noticeList.jsp?page=1"> 공지사항  </a> > <span> 공지사항 글 수정하기 </span> </p>
                <h2 class="page_tit"> 공지사항 글 수정 </h2>
            </div>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <form action="<%=path%>/notice/updateNoticePro.jsp" class="frm1" method="post">
                    <table class="tb1">
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="content" id="content"><%=notice.getContent()%></textarea></td>
                        </tr>
                        <tr>
